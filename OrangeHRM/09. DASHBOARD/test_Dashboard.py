...
class OrangeHRMAdminUsers (unittest.TestCase):
    ...
    def dashboard_page(self):
        ...
        menuDashboard = driver.find_element(By.XPATH, "//b[normalize-space()='Dashboard']")

        action.move_to_element(menuDashboard).click().perform()

    def test_a_check_dashboard_page (self): 
        driver = self.driver

        self.dashboard_page()

        dashboardTitlePage = driver.find_element(By.XPATH, "//*[@id='content']/div/div[1]/h1").text
        self.assertIn("Dashboard", dashboardTitlePage)
        expectedUrl= driver.current_url
        self.assertIn(expectedUrl, self.dashboardUrl)
